...
public class mohMenu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("RETURNS VIEW", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("SUMMERY VIEW", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        listMenu1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "PROFILE", "RETURNS VIEW", "SUMMERY VIEW", "LOGOUT" };
